...
function usage() {
  return ok({
    usage:
      "node scripts/update-integration.js --integration-id <id> [--configured-props <json>] [--name <text>] [--variable-definitions <json>] [--dynamic-props-id <id>]",
    notes: ["Use --variable-definitions to update required tool input fields."],
